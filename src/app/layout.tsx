...
export const metadata: Metadata = {
  title: "Grandeur Hotel - Luxury Accommodation & World-Class Service",
  description: "Experience unparalleled luxury at Grandeur Hotel. Elegant suites, fine dining, spa wellness, and exceptional service in the heart of the city.",
  keywords: "luxury hotel, premium accommodation, fine dining, spa wellness, concierge service, city hotel, elegant suites",
  metadataBase: new URL("https://grandeurhotel.com"),
  alternates: {
    canonical: "https://grandeurhotel.com"
  },
  openGraph: {
    title: "Grandeur Hotel - Luxury Redefined",
    description: "Discover world-class amenities, exquisite dining, and unparalleled service at Grandeur Hotel",
    siteName: "Grandeur Hotel",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T4ddGC7kKKMdLbBqUvMgbBzGM/uploaded-1763411875503-cr8kcu0m.jpg",
      alt: "Grandeur Hotel luxury lobby"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Grandeur Hotel - Luxury Accommodation",
    description: "Experience luxury redefined with world-class amenities and exceptional service",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T4ddGC7kKKMdLbBqUvMgbBzGM/uploaded-1763411875503-cr8kcu0m.jpg"]
  },
  robots: {
    index: true,
    follow: true
